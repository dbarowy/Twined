...
\subsection*{Semantics}
  ...
  \begin{table}[h!]
    \begin{center}
      ...
      %   \hline
      %   \text{NodeInfo} & Info of string & N/A & NodeInfo is a primative\\
      %   & & & represented using an f\# string\\
      ...
      %   & & & connected to in an f\# list \\
      %   \hline
      %   \text\{node\} \{node\}  & Node list & N/A & a series of nodes\\
      %   & & & separated by whitespace including\\ 
      %   & & & newlines these are used to store all \\
      %   & & & nodes in a graph\\
        
      %   \hline
      %   \texttt{^^NodeName := NodeInfo^^} & Assignment of NodeName := NodeInfo & N/A & a combining for that\\
      %   & & & uses a NodeName and its \\
      %   & & & associated information stored\\
      %   & & & in an f\# map \\

      %   \hline
      %   \texttt{^^NodeName := NodeInfo^^}  \texttt{^^NodeName := NodeInfo^^}& List of Assignment & N/A & A series of assignments\\
      %   & & &  to be stored in an environment\\

      %   \hline
      %   \text{NodeList}  \text{AssignmentList}& tuple of NodeList AssignmentList & N/A & a list of nodes\\
      %   & & &  that form the graph\\
      %   & & &  and the assignments of\\
      %   & & &  each node\\
